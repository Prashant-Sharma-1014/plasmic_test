...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: smr2aM6927y/css
import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: 2MVK-CXBu7v/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__yKre)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__x2PmT)}
              />
            </React.Fragment>
          ),
